...
##################### LOAD THE DATA #############################
df = pd.read_csv('C:/Users/anudi/OneDrive/Desktop/MLprojects/IRIS-Flower-classification/iris-with-answers.csv')
df1 = pd.read_csv('C:/Users/anudi/OneDrive/Desktop/MLprojects/IRIS-Flower-classification/iris-with-answers.csv')
df
